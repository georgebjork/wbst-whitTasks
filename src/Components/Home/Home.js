...
import { Button, Col, Container, Row, Card, Form, Image, Carousel } from 'react-bootstrap'
                ...
                <Container className="col-10">
                    ...
                    <Container fluid className="bg-dark p-5">
                        ...
                        <h1 class="text-center fst-italic display-6 text-white">
                            "I like the idea of consolidating all my school related activities into one platform."</h1>
